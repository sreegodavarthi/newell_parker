...
colors.init = function (elms) {
    ...
    elms.each(function () {
        ...
        var html = '<span>' + name + '</span><span>' + color + '</span>';
...
menu.click = function (e) {
    ...
    // Do search
    var fnd = $('.f-menu-container [data-search] input');
    var arr = fnd.val().split(' ');
